 ...
 */
@Autonomous(group = "Red", name = "R_2B Shoot 3 Rush")
public class Red2B3ShootRush extends LinearOpMode{
    Robot robot = new Robot();
    @Override
    public void runOpMode() throws InterruptedException {
        robot.initialize(Red2B3ShootRush.this, hardwareMap, telemetry, true);
        waitForStart();
